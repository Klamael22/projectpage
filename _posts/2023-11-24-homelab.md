...
# Project Goals:
This project will consist of creating a virtualized homelab in Proxmox. To start, this lab will be comprised of pfSense, Windows Server, and a few Windows 10 clients. I have already created several homelabs with Proxmox, but have not documented the process before. My primary goal is to gain hands-on experience with networking, firewalls, and Active Directory. After completing this initial setup I will be looking to experiment with other technologies, namely Snort and Splunk, but I shall walk before I run.
...
That's it for now, I'll cover the Windows 10 setup and domain joining in [this post](/_posts/2023-11-28-homelab-ad.md).

# pfSense Setup via webConfigurator
Now that we have the VMs installed, let's access pfSense webConfigurator via browser from the Windows Server VM, and run through the setup wizard. 
...
# Conclusion
Now I have the VMs created and a basic functional configuration for pfSense. Next, I will [setup Active Directory](/_posts/2023-11-28-homelab-ad.md)!